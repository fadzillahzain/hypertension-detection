...
export const getRekamMedis = async (page = 1) => {
  const response = await makeRequest.get(`/rekam?page=${page}`, {
...
export const getRekamMedisUser = async (page = 1) => {
  const response = await makeRequest.get(`/rekam/user?page=${page}`, {
    headers: { Authorization: `Bearer ${user.token}` },
  })
  return response.data
}
...
export async function createRekamMedis(newData) {
  return (
    await makeRequest.post('/rekam', newData, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export const getUserPages = async (page = 1) => {
  const response = await makeRequest.get(`/user/super?page=${page}`, {
    headers: { Authorization: `Bearer ${user.token}` },
  })
  return response.data
}
...
export const getPenyakit = async (page = 1) => {
  const response = await makeRequest.get(`/penyakit?page=${page}`, {
    headers: { Authorization: `Bearer ${user.token}` },
  })
  return response.data
}
export const getPenyakitAll = async () => {
  const response = await makeRequest.get(`/penyakit/all`, {
    headers: { Authorization: `Bearer ${user.token}` },
  })
  return response.data
}
...
export async function getPenyakitById(id) {
  return (
    await makeRequest.get(`/penyakit/${id}`, { headers: { Authorization: `Bearer ${user.token}` } })
  ).data
}
export async function createPenyakit(newData) {
  return (
    await makeRequest.post('/penyakit', newData, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export async function editPenyakit(newData) {
  return (
    await makeRequest.put(`/penyakit/${newData.id}`, newData, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export async function delPenyakit(id) {
  return (
    await makeRequest.delete(`/penyakit/${id}`, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export const getGejalaAll = async () => {
  const response = await makeRequest.get(`/gejala/all`, {
    headers: { Authorization: `Bearer ${user.token}` },
  })
  return response.data
}
...
export const getGejala = async (page = 1) => {
  const response = await makeRequest.get(`/gejala?page=${page}`, {
    headers: { Authorization: `Bearer ${user.token}` },
  })
  return response.data
}
...
export async function getGejalaById(id) {
  return (
    await makeRequest.get(`/gejala/${id}`, { headers: { Authorization: `Bearer ${user.token}` } })
  ).data
}
export async function createGejala(newData) {
  return (
    await makeRequest.post('/gejala', newData, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export async function editGejala(newData) {
  return (
    await makeRequest.put(`/gejala/${newData.id}`, newData, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export async function delGejala(id) {
  return (
    await makeRequest.delete(`/gejala/${id}`, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export const getAturan = async (page = 1) => {
  const response = await makeRequest.get(`/aturan?page=${page}`, {
    headers: { Authorization: `Bearer ${user.token}` },
  })
  return response.data
}
...
export async function getAturanById(id) {
  return (
    await makeRequest.get(`/aturan/${id}`, { headers: { Authorization: `Bearer ${user.token}` } })
  ).data
}
export async function createAturan(newData) {
  return (
    await makeRequest.post('/aturan', newData, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export async function editAturan(newData) {
  return (
    await makeRequest.put(`/aturan/${newData.id}`, newData, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
...
export async function delAturan(id) {
  return (
    await makeRequest.delete(`/aturan/${id}`, {
      headers: { Authorization: `Bearer ${user.token}` },
    })
  ).data
}
