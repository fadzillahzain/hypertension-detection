...
const WidgetsDropdownMember = (props) => {
      ...
      <CCol sm={6} xl={4} xxl={3} >
        <CCard className='bg-success'>
          ...
          <CIcon icon={cilFolder} size='xl' className='mx-2'/>
              <p className='mx-1 mb-0' style={{fontSize:'20px'}}>Riwayat Diagnosis</p>
...
WidgetsDropdownMember.propTypes = {
  className: PropTypes.string,
  withCharts: PropTypes.bool,
}

export default WidgetsDropdownMember
